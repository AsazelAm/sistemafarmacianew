        ...
        laboratorios.forEach(laboratorio => {
            template+=`
                ...
                labAvatar="${laboratorio.avatar}">
                   ...
                   <td>
                        <img src="${laboratorio.avatar}" class="img-fluid rounded" width="70" heigth="70"></img>
                   </td>
...
$(document).on('keyup','#buscar-laboratorio',function(){
    ...
    $('#form-logo').submit(e => {
        let formData = new FormData($('#form-logo')[0]); //con esto capturamos los datos del formulario
        $.ajax({
